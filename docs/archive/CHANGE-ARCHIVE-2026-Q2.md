# CHANGE-ARCHIVE-2026-Q2.md — Archived session summaries

> Format: `.md` | Quota: Q2 (April–June 2026) | Trimmed from `docs/CHANGE-LOG.md` on 2026-07-22 per AGENTS.md retention rule (last 30 sessions / 14 days)
>
> **Note**: These sessions remain retrievable from git history (`git log --before=2026-07-08 -- docs/CHANGE-LOG.md`).
